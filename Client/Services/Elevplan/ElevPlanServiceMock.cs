...
namespace Client
{
    ...
    public class ElevPlanServiceMock : IElevPlan
    {
        ...
        public ElevPlanServiceMock()
        {
            Plan nyplan = CreateKokkeUddannelseTemplate();
            allePlaner.Add(nyplan);
        }
        
        public async Task<Plan> CreatePlanFromTemplate(int studentId)
        {
            var plan = CreateKokkeUddannelseTemplate();
            return plan;
        }
